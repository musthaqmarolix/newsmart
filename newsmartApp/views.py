...
def userRegistration(request):
    try:
        if request.method!= "POST":
            ...
            isNewsChanelOwner = data.get('isNewsChanelOwner')

            user = User.objects.create_user(email = email, password = passwordd, username = usernamee, first_name = fName, last_name = lName,con=contact)
